...
data = {
	...
	1007:Record(1007,'normal','摇尾巴',4,'is_enemy',2,(('add_buff',{'base_value':'20','buff_id':'202','turn':'2'}),)),
	...
	1011:Record(1011,'normal','变硬',1,'is_self',1,(('add_buff_user_property',{'base_value':'0.1','buff_id':'105','turn':'10'}),)),
	...
	2006:Record(2006,'grass','麻痹粉',5,'is_enemy',1,(('add_buff',{'base_value':'10','buff_id':'203','turn':'2'}),('add_buff',{'buff_id':'306','execute_prob':'0.5','turn':'2'}))),
	...
	4002:Record(4002,'water','缩入壳中',1,'is_self',1,(('add_buff',{'base_value':'0.2','buff_id':'105','turn':'2'}),)),
	4003:Record(4003,'water','水枪',5,'is_enemy',2,(('damage',{'rate':'1.4'}),)),
	4004:Record(4004,'water','泡沫光纤',5,'is_enemy',2,(('damage',{'rate':'1'}),('add_buff',{'base_value':'20','buff_id':'203','turn':'2'}))),
	...
	9001:Record(9001,'bug','吐丝',5,'is_enemy',2,(('damage',{'rate':'0.25'}),('add_buff',{'base_value':'30','buff_id':'203','turn':'1'}),('add_buff',{'buff_id':'304','execute_prob':'0.5','turn':'1'}))),
	...
	600101:Record(600101,'dragon','龙怒+伤害',1,'is_self',1,(('add_buff',{'base_value':'0.35','buff_id':'104','turn':'10'}),)),
