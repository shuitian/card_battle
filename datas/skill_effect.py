...
data = {
	...
	1002:Record(1002,'normal','叫声',4,'is_enemy',2,(('add_buff',{'base_value':'15','buff_id':'201','turn':'2'}),)),
	1003:Record(1003,'normal','生长',1,'is_self',1,(('add_buff',{'base_value':'0.1','buff_id':'104','turn':'10'}),)),
	1004:Record(1004,'normal','抓',1,'is_enemy',1,(('damage',{'rate':'0.5'}),)),
	...
	1007:Record(1007,'normal','摇尾巴',4,'is_enemy',2,(('add_buff',{'base_value':'15','buff_id':'202','turn':'2'}),)),
	...
	2002:Record(2002,'grass','飞叶快刀',5,'is_enemy',2,(('damage',{'rate':'1.5'}),('add_buff',{'base_value':'10','buff_id':'202','turn':'2'}))),
	2003:Record(2003,'grass','日光术',4,'is_enemy',1,(('damage',{'rate':'2.2'}),)),
	2004:Record(2004,'grass','寄生种子',5,'is_enemy',3,(('add_buff',{'base_value':'15','buff_id':'1001','turn':'10'}),)),
	2005:Record(2005,'grass','花瓣舞',5,'is_enemy',3,(('damage',{'rate':'1.5'}),)),
	3001:Record(3001,'fire','火花',3,'is_enemy',1,(('damage',{'rate':'1.5'}),('add_buff',{'base_value':'10','buff_id':'1002','turn':'2'}))),
	3002:Record(3002,'fire','喷射火焰',4,'is_enemy',2,(('damage',{'rate':'1.5'}),('add_buff',{'base_value':'10','buff_id':'1002','turn':'2'}))),
	4001:Record(4001,'water','泡沫',4,'is_enemy',1,(('damage',{'rate':'0.5'}),('add_buff',{'base_value':'20','buff_id':'203','turn':'1'}))),
	4002:Record(4002,'water','缩入壳中',1,'is_self',1,(('add_buff',{'base_value':'10','buff_id':'102','turn':'2'}),)),
